...
<div class="modal fade" id="modal-contact-buy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="reason" name="reason" class="form-control" required>
                                ...
                                <option value="AL" selected>Buying</option>
                                <option value="AL">Selling</option>
                            </select>
                        </div>
                    </div>
